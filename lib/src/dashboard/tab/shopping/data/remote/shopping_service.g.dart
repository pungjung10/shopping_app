...
class _ShoppingService implements ShoppingService {
  ...
  @override
  Future<HttpResponse<List<ItemResponse>?>> getRecommendedProduct() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<ItemResponse>>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
